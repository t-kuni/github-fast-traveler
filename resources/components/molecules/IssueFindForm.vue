<template>
    <b-form @submit="onClickFind">
        <b-form-group label="Find Scope">
            <b-form-radio-group class="select-scope-area"
                ...
                <b-card-group>
                    ...
                    <b-card v-if="hasLoginName" @click="() => this.searchType = 'my-repo'"
                            :class="{active: searchType === 'my-repo'}">
        ...
        <b-form-group label="State">
            <b-form-radio v-model="searchState" value="all" inline>All</b-form-radio>
            <b-form-radio v-model="searchState" value="open" inline>Open</b-form-radio>
            <b-form-radio v-model="searchState" value="closed" inline>Closed</b-form-radio>
        </b-form-group>
...
export default {
    ...
    computed: {
        ...
        issueFindingInteractor() {
            return container.resolve('IssueFindingInteractor');
        },
        hasLoginName() {
    ...
    methods: {
        onClickFind() {
            this.issueFindingInteractor.find(this.searchType, this.searchWord, this.searchState);
        },
        onShow() {
            setTimeout(() => {
